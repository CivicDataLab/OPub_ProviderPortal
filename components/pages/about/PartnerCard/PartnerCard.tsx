  ...
  return (
    <PartnersCard>
      <div className="partners__header">
        <Link href={card.url ? card.url : '#'} passHref>
          {card.img ? (
            <Image
              src={card.img}
              alt={`${card.title} Image`}
              title={`${card.title} Image | Click to go to Partner Website`}
        ...
        <section>
          <Link href={card.url ? card.url : '#'} passHref>
            <h4 title='Partner Name | Click to go to their website'>{card.name}</h4>
          </Link>
          <small>{card.title}</small>
          <div className="partners__social">
            {card.twitter && (
              <a title="Follow Provider on Twitter" href={card.twitter}>
                <svg
            ...
            {card.linkedin && (
              <a title="Follow Provider on LinkedIn" href={card.linkedin}>
                <svg
                  width="30"
                  height="30"
                  viewBox="0 0 30 30"
            ...
            {card.github && (
              <a title="Follow Provider on Github" href={card.github}>
                <svg
                  width="30"
                  height="30"
                  viewBox="0 0 30 30"
