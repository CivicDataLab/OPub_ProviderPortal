  ...
  React.useEffect(() => {
    if (resourceId) {
      const updateResourceObj = {
        ...
        file: editObj.file_details?.file,
        remote_url: editObj.file_details?.remote_url,
        format: {
    ...
    <>
      <ComponentWrapper>
        ...
        <InstructionsWrapper>
          ...
          <div>
            <ul>
              <li>Supported file types are CSV, JSON and XML.</li>
              <li>The file size should not be more than 8 MB.</li>
              <li>The file should be UTF-8 encoded.</li>

              <li>
                CSV is the preferred format for converters and transformations
                to work.
              </li>
              <li>
                If sharing a CSV file, ensure that there are no special
                characters or spaces.
              </li>
              <li>
                If sharing a JSON file, use&nbsp;
                <a
                  href="/assets/Sample1.json"
                  download={'JsonSampleFormat1.json'}
                >
                  Json Sample Format 1
                </a>{' '}
                or{' '}
                <a
                  href="/assets/Sample2.json"
                  download={'JsonSampleFormat2.json'}
                >
                  Json Sample Format 2
                </a>
                .{' '}
              </li>
              <li>
                If sharing an XML file, use&nbsp;
                <a href="/assets/sample.xml" download={'XmlFormat.xml'}>
                  Xml Format
                </a>
                .{' '}
              </li>
